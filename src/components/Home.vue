    ...
    <el-row :gutter="20">
      <el-col :span="16">
        <el-card class="box-card" shadow="hover">
          ...
          <div ref="liveRate" style="left:0;width: 100%;height: 250px"></div>
        </el-card>
      </el-col>
      <el-col :span="8">
        <el-card class="box-card" shadow="hover">
          ...
          <div ref="roomType" style="left:0;width: 100%;height: 250px"></div>
        </el-card>
      </el-col>
    </el-row>
    <el-row :gutter="20">
      <el-col :span="16">
        <el-card class="box-card" shadow="hover">
          ...
          <div ref="order" style="left:0;width: 100%;height: 250px"></div>
        </el-card>
      </el-col>
      <el-col :span="8">
        <el-card class="box-card" shadow="hover">
          ...
          <div ref="orderType" style="left:0;width: 100%;height: 250px"></div>
        </el-card>
      </el-col>
    </el-row>
...
export default {
  ...
  methods: {
    ...
    //客房住宿率
    lrChart(){
      var myChart =  this.$echarts.init(this.$refs.liveRate)
      let option = {
        xAxis: {
          type: 'category',
    ...
    //房型比例
    rtChart(){
      var rtChart =  this.$echarts.init(this.$refs.roomType)
      rtChart.setOption({
        tooltip: {},
        series: [{
          name: '比例',
    ...
    //订单量
    orderChart(){
      var myChart =  this.$echarts.init(this.$refs.order)
      myChart.setOption({
        itemStyle:{
          color: '#409EFF',
        },
    ...
    //各类型订单比例
     ortChart(){
      var rtChart =  this.$echarts.init(this.$refs.orderType)
      rtChart.setOption({
        tooltip: {},
        series: [{
          name: '比例',
